...
import { Recycle, ArrowLeft, User, Award, Settings, Edit, Calendar, MapPin, Clock, ChevronRight, Leaf, BarChart3, ShoppingBag } from 'lucide-react';
...
function ProfilePage({ actor, principal }) {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-lg shadow-sm p-4 flex flex-col items-center">
              ...
              <span className="text-2xl font-bold text-green-800">{userData.recyclingPoints}</span>
              <span className="text-sm text-gray-600">Recycling Points</span>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 flex flex-col items-center">
              ...
              <span className="text-2xl font-bold text-green-800">{userData.nftsOwned}</span>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 flex flex-col items-center">
              ...
              <span className="text-2xl font-bold text-green-800">{userData.totalRecycled}</span>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 flex flex-col items-center">
              ...
              <span className="text-2xl font-bold text-green-800">{userData.carbonSaved}</span>
            ...
            <div className="p-4">
              {activeTab === "activity" && (
                <div className="space-y-4">
                  <h2 className="text-lg font-medium text-green-800 mb-4">Recent Activity</h2>
