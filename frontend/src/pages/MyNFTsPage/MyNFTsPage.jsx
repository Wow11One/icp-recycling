...
function MyNftsPage() {
    ...
    const handleUseNft = () => {
        ...
        const updatedNfts = myNfts.map((nft) =>
            nft.id === selectedNft.id ? { ...nft, status: "used", usedDate: new Date().toISOString().split("T")[0] } : nft,
        )
            ...
            <main className="container mx-auto py-12 px-4">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-gray-600 max-w-2xl mb-8">
                        View and manage your recycling reward NFTs. Use them to get discounts and special offers at participating
                        stores.
                    </p>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-sm ${filter === "all" ? "bg-green-600 text-white" : "bg-green-100 text-green-800 hover:bg-green-200"
                                            }`}
                                    >
                                        All
                                    </button>
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-sm flex items-center gap-1 ${filter === "unused" ? "bg-green-600 text-white" : "bg-green-100 text-green-800 hover:bg-green-200"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-sm flex items-center gap-1 ${filter === "used" ? "bg-green-600 text-white" : "bg-green-100 text-green-800 hover:bg-green-200"
                                            }`}
                                    >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                                {filteredNfts.map((nft) => (
                                    <div
                                        ...
                                        className={`bg-white rounded-lg overflow-hidden border border-green-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer ${selectedNft && selectedNft.id === nft.id ? "ring-2 ring-green-600" : ""
                                            }`}
                                    >
                                        <div className="relative">
                                            <img src={nft.image || "/placeholder.svg"} alt={nft.title} className="w-full h-40 object-cover" />
                                            ...
                                            <div
                                                className={`absolute bottom-2 left-2 px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 shadow-sm ${nft.status === "unused" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                                                    }`}
                                            >
                                                {nft.status === "unused" ? (
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-xs text-gray-500 mb-2">Acquired: {formatDate(nft.acquiredDate)}</p>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="p-6">
                                            <div className="relative mb-4">
                                                ...
                                                />
                                                <div
                                                    className={`absolute top-2 right-2 px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1 shadow-sm ${selectedNft.status === "unused"
                                            ...
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm font-medium text-gray-600">
                                                    {selectedNft.category.charAt(0).toUpperCase() + selectedNft.category.slice(1)}
                                                </span>
                                            </div>

                                            <h2 className="text-2xl font-bold text-green-800 mb-2">{selectedNft.title}</h2>
                                            <p className="text-gray-600 mb-4">{selectedNft.description}</p>

                                            <div className="space-y-2 text-sm">
                                                <div className="flex justify-between">
                                                    <span className="text-gray-500">Acquired:</span>
                                                    <span className="font-medium">{formatDate(selectedNft.acquiredDate)}</span>
                                                </div>
                                                <div className="flex justify-between">
                                        ...
                                        <div className="p-6 bg-gray-50 flex flex-col">
                                            ...
                                            {selectedNft.status === "unused" ? (
                                                    ...
                                                    <div className="bg-white p-4 rounded-lg border border-gray-200 mb-4">
                                                        {showQrCode ? (
                                                            ...
                                                            <div>
                                                                ...
                                                                {copiedCode && <p className="text-green-600 text-sm mb-2">Code copied to clipboard!</p>}
                                                                <button
                                                ...
                                                <div className="flex-grow flex flex-col items-center justify-center text-center p-6">
                                                    ...
                                                    <h4 className="text-lg font-medium text-gray-700 mb-2">This NFT has been used</h4>
